...
FONT_MENU_ru = config['fonts'].get('menu_ru', fallback = 'SourceSansPro,32,False,False').split(',')
FONT_DESC_ru = config['fonts'].get('desc_ru', fallback = 'SourceSerifPro,40,False,False').split(',')
FONT_INFO_ru = config['fonts'].get('info_ru', fallback = 'SourceSerifPro,32,False,False').split(',')
FONT_TEXT_ru = config['fonts'].get('text_ru', fallback = 'SourceSansPro,28,False,False').split(',')
# FONT_SMALL_ru = config['fonts'].get('small_ru', fallback = 'SourceSansPro,10,False,False').split(',')
FONT_METER_ru = config['fonts'].get('meter_ru', fallback = 'SourceSansPro,12,True,False').split(',')
# FONT_ALTIMETER_ru = config['fonts'].get('altimeter_ru', fallback = 'Arial,28,True,False').split(',')
FONT_MENU_zh = config['fonts'].get('menu_zh', fallback = 'SourceHanSansCN,24,False,False').split(',')
FONT_DESC_zh = config['fonts'].get('desc_zh', fallback = 'SourceHanSansCN,32,False,False').split(',')
FONT_INFO_zh = config['fonts'].get('info_zh', fallback = 'SourceHanSansCN,28,False,False').split(',')
FONT_TEXT_zh = config['fonts'].get('text_zh', fallback = 'SourceHanSansCN,28,False,False').split(',')
# FONT_SMALL_zh = config['fonts'].get('small_zh', fallback = 'SourceHanSansCN,10,False,False').split(',')
FONT_METER_zh = config['fonts'].get('meter_zh', fallback = 'SourceHanSansCN,12,True,False').split(',')
