...
FONT_WELCOME_zh = config['fonts'].get('welcome_zh', fallback = 'Arial,64,False,False').split(',')
FONT_WELCOME_ru = config['fonts'].get('welcome_ru', fallback = 'Arial,64,False,False').split(',')
...
FONT_MENU_ru = config['fonts'].get('menu_ru', fallback = 'None,40,False,False').split(',')
FONT_DESC_ru = config['fonts'].get('desc_ru', fallback = 'timesnewroman,48,False,False').split(',')
FONT_INFO_ru = config['fonts'].get('info_ru', fallback = 'timesnewroman,32,False,False').split(',')
FONT_TEXT_ru = config['fonts'].get('text_ru', fallback = 'None,32,False,False').split(',')
FONT_SMALL_ru = config['fonts'].get('small_ru', fallback = 'None,16,False,False').split(',')
FONT_METER_ru = config['fonts'].get('meter_ru', fallback = 'Arial,16,True,False').split(',')
FONT_ALTIMETER_ru = config['fonts'].get('altimeter_ru', fallback = 'Arial,28,True,False').split(',')
FONT_MENU_zh = config['fonts'].get('menu_zh', fallback = 'None,40,False,False').split(',')
FONT_DESC_zh = config['fonts'].get('desc_zh', fallback = 'timesnewroman,48,False,False').split(',')
FONT_INFO_zh = config['fonts'].get('info_zh', fallback = 'timesnewroman,32,False,False').split(',')
FONT_TEXT_zh = config['fonts'].get('text_zh', fallback = 'None,32,False,False').split(',')
FONT_SMALL_zh = config['fonts'].get('small_zh', fallback = 'None,16,False,False').split(',')
FONT_METER_zh = config['fonts'].get('meter_zh', fallback = 'Arial,16,True,False').split(',')
FONT_ALTIMETER_zh = config['fonts'].get('altimeter_zh', fallback = 'Arial,28,True,False').split(',')
