...
FONT_DESC_ru = config['fonts'].get('desc_ru', fallback = 'NotoSerifDisplay,40,False,False').split(',')
FONT_INFO_ru = config['fonts'].get('info_ru', fallback = 'NotoSerifDisplay,28,False,False').split(',')
FONT_TEXT_ru = config['fonts'].get('text_ru', fallback = 'NotoSans,28,False,False').split(',')
# FONT_SMALL_ru = config['fonts'].get('small_ru', fallback = 'NotoSans,10,False,False').split(',')
